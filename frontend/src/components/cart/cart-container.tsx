    ...
    return (
        <div>
            <div className="flex items-center gap-2">
                <Image src={'/assets/ui/shopping-bag-4-line-black.png'} alt="" width={24} height={24} />
            ...
            <div className="flex flex-col md:flex-row gap-8 mt-9">
                <div className="flex-1">
                    <CartProductList initiaList={initialCartProducts} />
                </div>
                    ...
                    <div className="bg-white border border-gray-200 rounded-sm">
                        ...
                        <div className="p-6">
                            ...
                            <div className="text-center mt-6">
                                <Link href={'/'} className="text-xs text-gray-500 text-center" >Comprar outros produtos</Link>
                            </div>
                        </div>
                    </div>
                </div>
