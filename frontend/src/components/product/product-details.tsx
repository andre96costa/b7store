    ...
    return (
        <div className="flex-1">
            ...
            <div className="flex gap-4">
                <button onClick={addToCart} className="flex-1 max-w-xs py-4 px-8 bg-blue-600 text-white border-0 rounded-sm hover:opacity-90 cursor-pointer">Adicionar ao carrinho</button>
