...
export function Header(){
    const menu: MenuItem[] = [
        ...
        {label: 'Acessórios', href: '/categories/kits'},
        {label: 'Eletrônicos', href: '/categories/kits'},
    ];
        ...
        <header className="bg-white border-b border-gray-100">
            ...
            <div className="w-full max-w-6xl mx-auto p-6">
                <div className="flex items-center justify-between">
                    <div className="w-32">
                        <Link href={'/'}>
                            <Image src="/assets/ui/logo-black.png" alt="b7store" width={120} height={40} />
                        </Link>
                    </div>
                    ...
                    {menu.map(item => (
                        <Link key={item.label} href={item.href}>
                            <div className="p-6 border-b border-gray-200 flex items-center justify-between">
                                ...
                                <Image src="/assets/ui/arrow-up-right.png" alt="Ir  a categoria" width={24} height={24} />
                            </div>
